<div id="quntty_tab" class="tab-pane fade" role="tabpanel">
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="related_to" class="form-control" id="related_to">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>القائمة المرتبطة</label>
                                            <select name="time_line_id" class="form-control" required>
                                                <option value="">اختار قائمة</option>
                                                @foreach($project->timeLines as $time_line)
                                                    <option value="{{$time_line->id}}">{{$time_line->nameWithAllParents()}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
            ...
            {{-- add new schedule --}}
            {{-- add new sckedule sort --}}
            <div class="modal fade" id="add_new_schedule_sorts" tabindex="-1" role="dialog"
                 aria-labelledby="exampleModalLabel1">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="">انشاء عناصر الجدول الزمني
                                <i class="fas fa-sort-amount-down"></i>
                            </h5>
                        </div>
                        <div class="modal-body">
                            <form method="post" action="{{route('time-lines.store')}}" id="schedule_sort_form">
                                <input type="hidden" name="project_id" value="{{$project->id}}">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-warning" form="schedule_sort_form">
                                انشاء قائمة جدول زمني
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button class="btn btn-danger btn-block" data-toggle="modal" data-target="#add_new_schedule_sorts"
                            data-whatever="@">
                        <i class="fas fa-sort-amount-down"></i> قوائم الجداول الزمنية
                    </button>
                </div>
            </div>
        </div>
