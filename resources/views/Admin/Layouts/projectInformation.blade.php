                            ...
                            <div class="panel-group accordion-struct" id="accordion_1" role="tablist"
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading activestate" role="tab" id="heading_4">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                           data-parent="#accordion_1" href="#collapse_0" aria-expanded="true">بيانات
                                            اساسيه</a>
                                    </div>
                                    <div id="collapse_0" class="panel-collapse collapse in" role="tabpanel">
                                        <div class="panel-body pa-15">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{$project->owner->name}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{$project->contractor->name}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10" for=""> قيمه العقد
                                                            الاصليه </label>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{$project->contract_value}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label mb-10" for="">مده العقد
                                                            الاصليه </label>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{dateDiff($project->contract_starting,$project->contract_ending)->days}} يوم"
                                                                   readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="قيمه العقد الحاليه" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="مده العقد الحاليه " readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="panel-wrapper collapse in">
                                                        ...
                                                        <div class="modal fade meum" tabindex="-1" role="dialog"
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        ...
                                                                        <h5 class="modal-title" id="">بيانات مدير
                                                                            المشروع</h5>
                                                                    </div>
                                                                    @if(!is_null($project->projectManager()))
                                                                        <div class="modal-body">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                       id=""
                                                                                       value="{{$project->projectManager()->engineer->name}}"
                                                                                       readonly>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="recipient-name"
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                       id=""
                                                                                       value="{{$project->projectManager()->engineer->email}}"
                                                                                       readonly>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="tel" class="form-control"
                                                                                       id=""
                                                                                       value="{{$project->projectManager()->engineer->information->phone}}"
                                                                                       readonly>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="message-text"
                                                                                ...
                                                                                <input type="tel" class="form-control"
                                                                                       id=""
                                                                                       value="{{$project->projectManager()->engineer->information->phone2}}"
                                                                                       readonly>
                                                                            </div>
                                                                        </div>
                                                                    @endif
                                                        ...
                                                        @if(!is_null($project->projectManager()))
                                                            <div class="input-group">
                                                                <div class="input-group-addon"
                                                                     style="background-color:#EEEEEE;"><i
                                                                            class="icon-user"></i></div>
                                                                <input data-toggle="modal" data-target=".meum"
                                                                       type="text"
                                                                       style="background-color:#FFFFFF; font-weight:bold;"
                                                                       class="form-control text-muted" id=""
                                                                       value="{{$project->projectManager()->engineer->name}}"
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading_4">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                           data-parent="#accordion_1" href="#collapse_4" aria-expanded="false">بيانات
                                            اخري</a>
                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{$project->quantity->buildings_num}}"
                                                                   readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text"
                                                                   style="background-color:#FFFFFF; font-weight:bold;"
                                                                   class="form-control text-muted" id=""
                                                                   value="{{$project->quantity->steps}}" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading " role="tab" id="heading_1">
                                        <a role="button" data-toggle="collapse" data-parent="#accordion_1"
                                           href="#collapse_1" aria-expanded="false">مهندسي الاستشاري</a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading_2">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                           data-parent="#accordion_1" href="#collapse_2" aria-expanded="false">مهندسين
                                            المقاول </a>
                                    </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading" role="tab" id="heading_3">
                                        <a class="collapsed" role="button" data-toggle="collapse"
                                           data-parent="#accordion_1" href="#collapse_3" aria-expanded="false">منسق
                                            المالك</a>
                                    </div>
